			...
			<Dialog open={open} handler={handleOpen}>
				...
				<DialogBody>
					<div className="flex flex-col gap-4">
						...
						<Textarea id="contentInput" variant="outlined" label="Question" required/>
						<Checkbox
					...
					{success && <Success className="mt-2" message="Question submitted successfully! We'll get back to you soon."/>}
				</DialogBody>
